...
<head>
  ...
  <title>XTND CMS | Dashboard</title>
  <!-- Tell the browser to be responsive to screen width -->
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <!-- Font Awesome -->

  <link rel="stylesheet" href="{{ URL::asset('vendor/xtnd/cms/plugins/fontawesome-free/css/all.min.css') }}">
  
  <!-- <link rel="stylesheet" href="plugins/fontawesome-free/css/all.min.css"> -->
  <!-- Ionicons -->
  <link rel="stylesheet" href="https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">
  <!-- Tempusdominus Bbootstrap 4 -->
  <link rel="stylesheet" href="{{ URL::asset('vendor/xtnd/cms/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css')}}">
  <!-- iCheck -->
  <link rel="stylesheet" href="{{ URL::asset('vendor/xtnd/cms/plugins/icheck-bootstrap/icheck-bootstrap.min.css')}}">
  <!-- JQVMap -->
  ...
  <!-- Daterange picker -->
  <link rel="stylesheet" href="{{ URL::asset('vendor/xtnd/cms/plugins/daterangepicker/daterangepicker.css')}}">
  <!-- summernote -->
  <link rel="stylesheet" href="{{ URL::asset('vendor/xtnd/cms/plugins/summernote/summernote-bs4.css')}}">
  <link rel="stylesheet" href="{{ URL::asset('vendor/xtnd/cms/plugins/datatables-bs4/css/dataTables.bootstrap4.css')}}">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="{{ URL::asset('vendor/xtnd/cms/dist/img/user1-128x128.jpg')}}" alt="User Avatar" class="img-size-50 mr-3 img-circle">
          ...
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="{{ URL::asset('vendor/xtnd/cms/dist/img/user8-128x128.jpg')}}" alt="User Avatar" class="img-size-50 img-circle mr-3">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  John Pierce
          ...
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="{{ URL::asset('vendor/xtnd/cms/dist/img/user3-128x128.jpg')}}" alt="User Avatar" class="img-size-50 img-circle mr-3">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  Nora Silvester
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="/cms/table/{{$table}}" class="nav-link">
...
<!--           
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2014-2019 <a href="http://xtnd.io">XTND</a>.</strong>
    All rights reserved.
...
<!-- jQuery -->
<script src="{{ URL::asset('vendor/xtnd/cms/plugins/jquery/jquery.min.js')}}"></script>
<!-- jQuery UI 1.11.4 -->
<script src="{{ URL::asset('vendor/xtnd/cms/plugins/jquery-ui/jquery-ui.min.js')}}"></script>
<!-- Resolve conflict in jQuery UI tooltip with Bootstrap tooltip -->
<script>
  $.widget.bridge('uibutton', $.ui.button)
</script>
<!-- Bootstrap 4 -->
<script src="{{ URL::asset('vendor/xtnd/cms/plugins/bootstrap/js/bootstrap.bundle.min.js')}}"></script>
<!-- ChartJS -->
...
<!-- jQuery Knob Chart -->
<script src="{{ URL::asset('vendor/xtnd/cms/plugins/jquery-knob/jquery.knob.min.js')}}"></script>
<!-- daterangepicker -->
...
<!-- overlayScrollbars -->
<script src="{{ URL::asset('vendor/xtnd/cms/plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js')}}"></script>
<!-- AdminLTE App -->
...
<script src="{{ URL::asset('vendor/xtnd/cms/plugins/select2/js/select2.full.min.js')}}"></script>

<script src="{{ URL::asset('vendor/xtnd/cms/plugins/inputmask/min/jquery.inputmask.bundle.min.js')}}"></script>
})
<script src="{{ URL::asset('vendor/xtnd/cms/plugins/summernote/summernote-bs4.min.js')}}"></script>


<!-- AdminLTE for demo purposes -->
<script src="{{ URL::asset('vendor/xtnd/cms/dist/js/demo.js')}}"></script>
